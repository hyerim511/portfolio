...
export default function WorkList() {
    ...
    return (
        <main className={styles.works}>
            ...
            <div>
                <p><Link href="https://github.com/hyerim511">See other development projects</Link></p>
                <p><Link href="https://www.figma.com/proto/KQkqEg0YJ2VKtVCepYo33Q/Haley-Kim?page-id=123%3A5736&type=design&node-id=550-1498&viewport=309%2C453%2C0.12&t=WjSo5P4ImecfCJPw-1&scaling=contain&starting-point-node-id=550%3A1498&mode=design">See other Design projects</Link></p>
            </div>
        </main>
    )
}